    ...
    <>
      <section className="bg-primary py-20 text-center text-white">
        ...
        <p className="mx-auto mt-2 max-w-2xl text-sm text-white/50">
          Celestial Church of Christ &mdash; Calgary Model Parish
        </p>
      </section>
      ...
      <section className="py-16">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          ...
          <Card className="p-8">
            ...
            {/* Fund designation — select first so email updates */}
            <div className="mb-6">
            ...
            {/* Email to send to — changes per fund */}
            ...
            {/* Badges */}
            <div className="flex flex-col items-center gap-3 border-t border-border pt-5 text-xs text-muted">
              ...
              <p className="text-muted/70">Charity Registration No: CH2202020324040</p>
            </div>
          </Card>
