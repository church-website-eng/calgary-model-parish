  ...
  return (
    <div>
      ...
      <div className="max-w-2xl space-y-8">
        {/* Page Photo */}
        <div>
          <h2 className="mb-3 text-lg font-semibold text-foreground">Page Photo</h2>
          <Card className="p-4">
            <label className="mb-1 block text-sm font-medium text-muted">Photo URL</label>
            <input
              value={(data as AboutData & { pagePhoto?: string }).pagePhoto || ""}
              onChange={(e) => setData({ ...data, pagePhoto: e.target.value } as AboutData)}
              placeholder="/images/church-building.png or upload via Media Library"
            ...
            />
            <p className="mt-1 text-xs text-muted">The main photo shown at the top of the About page</p>
          </Card>
        </div>
