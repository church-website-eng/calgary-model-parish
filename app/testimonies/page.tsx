...
const fallbackTestimonies: Testimony[] = [
  {
    id: "1",
    name: "Brother Ayo",
    body: "I came to Calgary Model Parish seeking healing for a chronic illness that doctors said had no cure. Through the fervent prayers of the church and the grace of God, I received complete healing within three months. To God be the glory!",
