...
export async function POST(request: Request) {
  try {
    ...
    await sendEmail(
      email,
      "Welcome to Calgary Model Parish — Visit Confirmation",
      `<h2>Thank You, ${name}!</h2>
       <p>We are excited to welcome you to Celestial Church of Christ, Calgary Model Parish.</p>
